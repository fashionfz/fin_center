...
<body id="cc" class="easyui-layout">
	<div data-options="region:'north',border:false" style="background:#FFFFFF;padding:0px">
	    ...
	    <div id="mm1" style="width:150px;">
	        <a id="check_report1" href="javascript:openUrl('getTablet.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-checkreport'">查询平板设备
	        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
	    ...
	    <div id="mm2" style="width:150px;">
	        <a id="device1" href="javascript:openUrl('getTabletUser.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-dvr'">查询人员
	        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <a id="group1" href="javascript:openUrl('loadTabletUser.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-group'">导入人员
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>	
            <a id="group1" href="javascript:openUrl('removeUser.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-group'">删除人员
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>            
	    </div>
        <div id="mm4" style="width:150px;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <a id="sys_role1" href="javascript:openUrl('doCheck.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-role'">刷指纹
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <a id="sys_menu1" href="javascript:openUrl('endCheck.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-menu'">结束认证
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            <div class="menu-sep"></div>
            <a id="sys_service1" href="javascript:openUrl('offLineCheck.jsp')" class="easyui-linkbutton" data-options="disabled:false,plain:true,iconCls:'icon-menu'">离线日志上报
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>            
        </div>    
	</div>
