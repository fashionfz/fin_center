...
<Message>
<TabletUser name="zhansan" userNumber="12222" code="51398728282" compy="tianyi" phone="010-110"/>
</Message>
</textarea>
<br />
<input type="button" onclick="postData('#frm','getTabletUser.do?userId=1')" value="submit"/>
</form>
</fieldset> 
</td>
</tr>
