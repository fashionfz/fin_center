...
<form action="<%=basePath %>/install_setup.svl" method="post"
...
<input type="hidden" name="dbFileName"
	value="/install/db/fin_mysql.sql" /> <input type="hidden"
	name="initFileName" value="" />
</form>
</body>
</html>
